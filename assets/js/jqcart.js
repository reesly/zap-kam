...
;(function($) {
  ...
  var cartData,
    ...
    totalCnt = 0,
    visibleLabel = false,
    label = $('<div class="jqcart-cart-label"><span class="jqcart-title"><img class="" style="max-width: 26px;" src="/assets/img/cart.png"/></span><span class="jqcart-total-cnt">0</span></div>'),
    modal = '<div class="jqcart-layout"><div class="jqcart-checkout">123</div></div>',
    orderform = '<form class="jqcart-orderform"><input type="submit" class="btn btn-primary" value="Отправить заявку"><input class="btn btn-secondary" type="reset" value="Продолжить"></p></form>';
  var opts = {
		buttons: '.add_item',
		cartLabel: 'body',
		visibleLabel: false,
  ...
  var actions = {
    ...
    changeTotalCnt: function(n) {
      ...
      var m = +parseInt(cntOutput.first().text());
      cntOutput.each(function(){
          $(this).text((m + n));
        });
      return false;
    },
    openCart: function() {
      ...
      for (key in cartData) {
        if (cartData.hasOwnProperty(key)) {
          ...
          orderPreview += '<div class="jqcart-q"><span class="jqcart-incr" data-incr="-1">&#8211;</span><input type="text" class="jqcart-amount" value="' + cartData[key].count + '"><span class="jqcart-incr" data-incr="1">+</span></div>';
    ...
    sendOrder: function(e) {
      ...
      pars = 'https:' + '/' + '/forms.yandex.ru/u/5e5831b56296cf035c59867f/?iframe=1' + pars+'&answer_short_text_13331990=korzina';
  ...
  var methods = {
    ...
    addToCartJs: actions.addToCartJs,
